package com.owl.customview.ProgressBarDownload;
...
public class ProgressBarDownloadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_progressbar_download);
        final ProgressBarDownloadView downloadProgressView = (ProgressBarDownloadView) findViewById(R.id.dpv3);
        ...
        downloadProgressView.setOnProgressUpdateListener(new ProgressBarDownloadView.OnProgressUpdateListener() {
            @Override
