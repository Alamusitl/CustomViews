...
public class ProgressBarDownloadView extends View {

    private static final String TAG = ProgressBarDownloadView.class.getSimpleName();
    ...
    public ProgressBarDownloadView(Context context) {
        super(context);
    }

    public ProgressBarDownloadView(Context context, AttributeSet attrs) {
        super(context, attrs);
