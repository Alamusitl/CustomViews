 ...
 */
public class ArrowWaveDownloadButton extends View {
    ...
    public ArrowWaveDownloadButton(Context context) {
        this(context, null);
    }

    public ArrowWaveDownloadButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArrowWaveDownloadButton(Context context, AttributeSet attrs, int defStyleAttr) {
